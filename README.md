# MiSTercade V2 Freeplay Mappings (No Menu Combo)

V2 No-Menu Freeplay mapping database for the [MiSTercade](https://misteraddons.com/products/mistercade).

This variant has the **menu combo (Down + Start) disabled** so it cannot be accidentally triggered during gameplay. Start also triggers Coin (freeplay).
